...
handler.help = [
    '.gaymetro <@tag/nome>',
    '.lesbiometro <@tag/nome>',
    '.masturbometro <@tag/nome>',
    '.fortunometro <@tag/nome>',
    '.intelligiometro <@tag/nome>',
    '.bellometro <@tag/nome>'
];
handler.tags = ['giochi'];
handler.register = true;
handler.group = true;
handler.command = /^\.?(gaymetro|lesbiometro|masturbometro|fortunometro|intelligiometro|bellometro)$/i;
