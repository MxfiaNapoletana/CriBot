const handler = async (m, { conn }) => {
  ...
  if (amount <= 0) 
    return m.reply('Inserisci un numero valido di messaggi da aggiungere!', m);
  ...
  conn.reply(m.chat, `𝐇𝐨 𝐚𝐠𝐠𝐢𝐮𝐧𝐭𝐨 *${amount}* 𝐦𝐞𝐬𝐬𝐚𝐠𝐠𝐢 𝐚 𝐪𝐮𝐞𝐬𝐭𝐨 𝐮𝐭𝐞𝐧𝐭𝐞!`, null, {'quoted': fakeQuote});
};
