...
const handler = async (m, { conn }) => {
  try {
    ...
    try {
      ...
      // Se non riesce a ottenere l'immagine del profilo, usa quella di default
...
`,
    ...
    conn.sendMessage(m.chat, { text: '❌ Si è verificato un errore durante il recupero delle informazioni.' }, { quoted: m });
  }
};
